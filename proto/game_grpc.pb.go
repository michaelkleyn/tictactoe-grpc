...
type GameServiceClient interface {
	...
	MakeMove(ctx context.Context, in *MakeMoveRequest, opts ...grpc.CallOption) (*JoinGameResponse, error)
...
func (c *gameServiceClient) MakeMove(ctx context.Context, in *MakeMoveRequest, opts ...grpc.CallOption) (*JoinGameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JoinGameResponse)
...
type GameServiceServer interface {
	...
	MakeMove(context.Context, *MakeMoveRequest) (*JoinGameResponse, error)
...
func (UnimplementedGameServiceServer) MakeMove(context.Context, *MakeMoveRequest) (*JoinGameResponse, error) {
